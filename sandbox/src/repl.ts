...
export interface RowDecoration {
  // v0.3.0: "warn" (amber) for regime-context annotations on rows that
  // touch a regime in a spanning query; "error" (red) for rows whose
  // own interval straddles a boundary cut (the value mixes regimes).
