...
// ===========================================================================
export function renderCellShell(source, kind) {
...
// ===========================================================================
export async function executeAndRenderInto(output, source, ts, tsModule) {
    output.innerHTML = "";
    ...
    try {
        ...
        renderErrorInto(output, [{ message: err instanceof Error ? err.message : String(err) }], trimmed, tsModule);
    }
}
// Dispatch a successful ExecuteResult to the right per-statement
// renderer, into `output`.
export function renderResultInto(output, result, tsModule) {
...
// COMPUTE
// ===========================================================================
export function renderComputeCell(source, result, tsModule) {
    const { cell, output } = renderCellShell(source, "compute");
    renderComputeInto(output, result, tsModule);
    return cell;
}
export function renderComputeInto(output, result, tsModule) {
...
// REGISTER
// ===========================================================================
export function renderRegisterCell(source, result) {
    const { cell, output } = renderCellShell(source, "register");
    renderRegisterInto(output, result);
    return cell;
}
export function renderRegisterInto(output, result) {
...
// ===========================================================================
export function renderCheckCell(source, result) {
    const { cell, output } = renderCellShell(source, "check");
    renderCheckInto(output, result);
    return cell;
}
export function renderCheckInto(output, result) {
...
// Errors
// ===========================================================================
export function renderErrorCell(source, errors, tsModule) {
    const { cell, output } = renderCellShell(source, "error");
    renderErrorInto(output, errors, source, tsModule);
    return cell;
}
export function renderErrorInto(output, errors, source, tsModule) {
...
// SHOW LEXICON
// ===========================================================================
export function renderShowLexiconCell(source, result) {
    const { cell, output } = renderCellShell(source, "show-lexicon");
    renderShowLexiconInto(output, result);
    return cell;
}
export function renderShowLexiconInto(output, result) {
...
// SHOW SCHEMA
// ===========================================================================
export function renderShowSchemaCell(source, result) {
    const { cell, output } = renderCellShell(source, "show-schema");
    renderShowSchemaInto(output, result);
    return cell;
}
export function renderShowSchemaInto(output, result) {
...
// UNREGISTER
// ===========================================================================
export function renderUnregisterCell(source, result) {
    const { cell, output } = renderCellShell(source, "unregister");
    renderUnregisterInto(output, result);
    return cell;
}
export function renderUnregisterInto(output, result) {
    if (result.found) {
        const banner = document.createElement("div");
        banner.className = "nb-register-banner";
        const msg = document.createElement("span");
