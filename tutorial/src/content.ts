...
export type Block =
  ...
  | { kind: "frozen"; source: string; seed?: string[] }
  | { kind: "interactive"; config: StandaloneCellConfig };
      ...
      cannedInputs: [
        {
          ...
          explanation:
            "The simplest query: one metric, no time filter. OVER is always required — all time means “don't scope the time axis.”",
        },
        {
      ...
      cannedInputs: [
        {
          ...
          explanation:
            "February overlaps the q1_data_quality_issue region. Note the “note” column and the “Lexicon entries in scope” table below the result.",
        },
        {
        ...
        },
        {
          ...
          explanation:
            "The outage region is scoped to region = 'northeast'. It triggers here; change the region and it won't.",
        },
        {
      ...
      cannedInputs: [
        {
          ...
          explanation:
            "This range straddles the cut. The single value blends two definitions, so it's flagged red — don't read it as one number.",
        },
        {
          code: "COMPUTE average_order_value OVER 2025-Q4 to 2026-Q1 GROUP BY quarter",
          explanation:
            "Same range, split by quarter. Now each row sits cleanly on one side — Q4 tagged (before), Q1 (after) — amber, not red.",
        },
        {
